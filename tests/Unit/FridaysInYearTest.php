...
final class FridaysInYearTest extends TestCase
{
    ...
    private static function fridaysIn2023() {
    ...
    private static function fridaysIn2022() {
    ...
    private static function fridaysIn2021() {
    ...
    private static function fridaysIn2020() {
    ...
    private static function fridaysIn2019() {
